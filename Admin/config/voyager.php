...
return [
    ...
    */
    ...
    'dashboard' => [
        ...
        'widgets' => [
            'App\\Widgets\\EstablishmentDimmer',
            'App\\Widgets\\CompanyDimmer',            
            'App\\Widgets\\ProductDimmer',
            'App\\Widgets\\EstablishmentReportDimmer',
            'App\\Widgets\\CompanyReportDimmer',
            'App\\Widgets\\ProductReportDimmer',
    ...
    */
    ...
    'googlemaps' => [
        'key'    => env('GOOGLE_MAPS_KEY', 'AIzaSyB3CdlgZZcibIjcHRtsulzCt8B2mUO3h2Q'),
        'center' => [
